			...
			if (world.provider instanceof MothershipWorldProvider) {
				...
				for (final Object o : entityList) {
					if (o instanceof Entity) {
						...
						// failsafe?
						if (e.world.provider instanceof MothershipWorldProvider) {
							if (e.posY < 0) {
								CelestialBody parent = ((MothershipWorldProvider) e.world.provider).getParent();
								if (parent == null) {
								...
								if (e instanceof EntityAutoRocket) {
									...
									MothershipWorldProvider msProvider = (MothershipWorldProvider) e.world.provider;
