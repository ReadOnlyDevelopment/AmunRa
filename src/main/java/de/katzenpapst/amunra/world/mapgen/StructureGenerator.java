...
/**
 * I'll do a subdivision now: StructureGenerator and Structure For each StructureGenerator there is a subclass of BaseStructure which it generates
 */
abstract public class StructureGenerator extends MapGenBaseMeta {
	...
	/**
	 * Clones an ArrayList of SubComponentData helper for generateSubComponents
	 *
	 * @param subCompData
	 * @return
	 */
	...
	/**
	 * Tries to find a sensible limit (aka total maximum of components) for the given list of SubComponentData helper for generateSubComponents
	 *
	 * @param subCompData
	 * @param rand
	 * @return
	...
	/**
	 * Just takes the "clazz" member of the entry and tries to create a new instance of it helper for generateSubComponents
	 *
	 * @param entry
	 * @return
	 */
	...
	/**
	 * Calculates the sum of all SubComponentData's probability values helper for generateSubComponents
	 *
	 * @param subCompData
	 * @return
	 */
