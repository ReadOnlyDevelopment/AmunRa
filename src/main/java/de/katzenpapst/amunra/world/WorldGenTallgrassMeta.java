...
import de.katzenpapst.amunra.old.block.bush.SubBlockBush;
...
public class WorldGenTallgrassMeta extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		for (int l = 0; l < 128; ++l) {
			...
			if (world.isAirBlock(curX, curY, curZ) && plant.canPlaceOn(world.getBlock(curX, curY - 1, curZ), world.getBlockMetadata(curX, curY - 1, curZ), 0)) {
