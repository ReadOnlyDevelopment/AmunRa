...
public class NeperChunkProvider extends AmunraChunkProvider {
	...
	protected SpawnListEntry[] getCreatures() {
		...
		return new SpawnListEntry[] { new SpawnListEntry(EntityCow.class, 25, 2, 4), new SpawnListEntry(EntityHorse.class, 1, 1, 2), new SpawnListEntry(EntitySheep.class, 1, 2, 4), new SpawnListEntry(EntityPig.class, 25, 2, 4), new SpawnListEntry(EntityChicken.class, 10, 2, 4) };
	}
