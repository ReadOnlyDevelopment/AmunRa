...
/**
 * Basically this thing is just one wrapper for a copy of ChunkProviderSpace::generateTerrain, just that it isn't inside a ChunkProviderSpace. I made this for Seth, which has basically two surfaces.
 */
public class TerrainGenerator {
	...
	/**
	 * Even "lighter" constructor. The other 4 values are set to 255, 4, 8, 8, since that's their values in ChunkProviderSpace
	 *
	 * @param rand
	 * @param stoneBlock
	 * @param airBlock
	 ...
	 * @param maxHeight             The space above the stones up to maxHeight gets filled up with airBlock. Also, no terrain will be generated above this
	...
	/**
	 * Basically a clone of micdoodle8.mods.galacticraft.api.prefab.world.gen.ChunkProviderSpace.generateTerrain I just need it in a more configurable form
	 *
	 * @param chunkX
	 * @param chunkZ
	 * @param idArray
