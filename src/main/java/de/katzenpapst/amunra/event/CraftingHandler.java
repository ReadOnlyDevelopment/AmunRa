...
import de.katzenpapst.amunra.old.item.ItemAbstractBatteryUser;
import de.katzenpapst.amunra.old.item.ItemBaseBattery;
import de.katzenpapst.amunra.old.item.ItemCryogun;
import de.katzenpapst.amunra.old.item.ItemNanotool;
import de.katzenpapst.amunra.old.item.ItemRaygun;
