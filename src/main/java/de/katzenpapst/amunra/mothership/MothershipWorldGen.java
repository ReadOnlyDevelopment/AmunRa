...
public class MothershipWorldGen extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int centerX, int centerY, int centerZ) {
		...
		/*
		 * 
		 * // (-)5, -6 => booster // (-)5, -5 => engine world.setBlock(centerX+5, centerY+1, centerZ-7, msEngine.getBlock(), msEngine.getMetadata(), 3); world.setBlock(centerX-5, centerY+1, centerZ-7, msEngine.getBlock(), msEngine.getMetadata(), 3);
		 * 
		 * int jetRotation = ARBlocks.metaBlockMachine.addRotationMeta(msJet.getMetadata(), 2); world.setBlock(centerX+5, centerY+1, centerZ-6, msJet.getBlock(), jetRotation, 3); world.setBlock(centerX-5, centerY+1, centerZ-6, msJet.getBlock(), jetRotation, 3);
		 */
		return true;
	}
}
