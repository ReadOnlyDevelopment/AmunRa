...
public interface ITileMothershipEngine {
	...
	/**
	 * Should return the direction in which the engine is pointing, and, by that, where it would push the ship value | motion direction | ------+----------------- + 0 | +Z | 1 | -X | 2 | -Z | 3 | +X |
	 */
	...
	/**
	 * This should return the force this engine can provide, in Newtons. This value should be independent of fuel levels, but can be dependent on the block's current configuration
	 */
