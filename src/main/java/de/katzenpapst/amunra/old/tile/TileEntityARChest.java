...
public class TileEntityARChest extends TileEntity implements IInventory {
	...
	public void checkForAdjacentChests() {
		...
		if (!this.adjacentChestChecked) {
			...
			if (this.isSameChestType(this.xCoord - 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXNeg = (TileEntityARChest) this.world.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
			}

			if (this.isSameChestType(this.xCoord + 1, this.yCoord, this.zCoord)) {
				this.adjacentChestXPos = (TileEntityARChest) this.world.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
			}

			if (this.isSameChestType(this.xCoord, this.yCoord, this.zCoord - 1)) {
				this.adjacentChestZNeg = (TileEntityARChest) this.world.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
			}

			if (this.isSameChestType(this.xCoord, this.yCoord, this.zCoord + 1)) {
				this.adjacentChestZPos = (TileEntityARChest) this.world.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
			}
	...
	public void closeInventory() {
		if (this.getBlockType() != null && this.getBlockType() instanceof BlockARChest) {
			...
			this.world.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
			this.world.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
			this.world.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType());
		}
	}
	...
	private boolean isSameChestType(int x, int y, int z) {
		if (chestType == null) {
			chestType = new BlockMetaPair(this.world.getBlock(this.xCoord, this.yCoord, this.zCoord), (byte) 0);
		}
	...
	public void updateEntity() {
		...
		if (!this.world.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0) {
			this.numUsingPlayers = 0;
			f = 5.0F;
			final List<?> list = this.world.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox(this.xCoord - f, this.yCoord - f, this.zCoord - f, this.xCoord + 1 + f, this.yCoord + 1 + f, this.zCoord + 1 + f));
		...
		if (this.numUsingPlayers > 0 && this.lidAngle == 0.0F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
			...
			this.world.playSoundEffect(d1, this.yCoord + 0.5D, d0, "random.chestopen", 0.5F, this.world.rand.nextFloat() * 0.1F + 0.6F);
		}
		...
		if (this.numUsingPlayers == 0 && this.lidAngle > 0.0F || this.numUsingPlayers > 0 && this.lidAngle < 1.0F) {
			...
			if (this.lidAngle < f2 && f1 >= f2 && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
				...
				this.world.playSoundEffect(d0, this.yCoord + 0.5D, d2, "random.chestclosed", 0.5F, this.world.rand.nextFloat() * 0.1F + 0.6F);
			}
