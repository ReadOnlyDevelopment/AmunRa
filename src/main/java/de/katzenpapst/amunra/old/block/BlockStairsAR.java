...
public class BlockStairsAR extends BlockStairs implements IMassiveBlock {
	...
	/**
	 * Called upon block activation (right click on the block.) Activate the clicked on block, otherwise use the held item. Args: player, world, itemStack, x, y, z, side, xOffset, yOffset, zOffset
	 */
	@Override
	...
	public void register() {
		...
		this.setHarvestLevel(sourceBlock.getBlock().getHarvestTool(sourceBlock.getMetadata()), sourceBlock.getBlock().getHarvestLevel(sourceBlock.getMetadata()));
