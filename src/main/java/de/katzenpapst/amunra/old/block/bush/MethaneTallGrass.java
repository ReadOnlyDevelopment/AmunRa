...
public class MethaneTallGrass extends SubBlockBush {
	...
	public MethaneTallGrass(String name, String texture, String tool, int harvestLevel, float hardness, float resistance) {
	...
	public boolean canPlaceOn(Block blockToCheck, int metaToCheck, int meta) {
		return blockToCheck == ARBlocks.blockMethaneGrass.getBlock() && metaToCheck == ARBlocks.blockMethaneGrass.getMetadata() || blockToCheck == ARBlocks.blockVacuumGrass.getBlock() && metaToCheck == ARBlocks.blockVacuumGrass.getMetadata();
		// return true;
	}
