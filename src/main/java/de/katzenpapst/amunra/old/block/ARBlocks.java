...
import de.katzenpapst.amunra.old.block.bush.ARTreeSapling;
import de.katzenpapst.amunra.old.block.bush.BlockBushMulti;
import de.katzenpapst.amunra.old.block.bush.MethaneTallGrass;
import de.katzenpapst.amunra.old.block.bush.PodSapling;
import de.katzenpapst.amunra.old.block.machine.BlockGravitation;
import de.katzenpapst.amunra.old.block.machine.BlockHydroponics;
import de.katzenpapst.amunra.old.block.machine.BlockIsotopeGenerator;
import de.katzenpapst.amunra.old.block.machine.BlockMothershipController;
import de.katzenpapst.amunra.old.block.machine.BlockMothershipSettings;
import de.katzenpapst.amunra.old.block.machine.BlockScale;
import de.katzenpapst.amunra.old.block.machine.BlockShuttleDock;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.BlockMothershipBoosterMeta;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.BlockMothershipJetMeta;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.MothershipEngineBoosterBase;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.MothershipEngineBoosterIon;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.MothershipEngineJetIon;
import de.katzenpapst.amunra.old.block.machine.mothershipEngine.MothershipEngineJetRocket;
import de.katzenpapst.amunra.old.block.ore.BlockOreMulti;
import de.katzenpapst.amunra.old.block.ore.SubBlockOre;
import de.katzenpapst.amunra.old.block.ore.SubBlockOreMultidrop;
...
public class ARBlocks {
	...
	public static void initBlocks() {
		...
		// MULTIORES
		// sub-ores first
		subGold = (SubBlockOre) new SubBlockOre("oreGold", "amunra:ore-gold").setOredictNames("oreGold").setHarvestInfo("pickaxe", 1).setHardness(3).setResistance(5);

		subAlu = (SubBlockOre) new SubBlockOre("oreAluminium", "amunra:ore-alu").setOredictNames("oreAluminum", "oreAluminium", "oreNaturalAluminum").setHarvestInfo("pickaxe", 2).setHardness(3).setResistance(5);

		subCopper = (SubBlockOre) new SubBlockOre("oreCopper", "amunra:ore-copper").setOredictNames("oreCopper").setHarvestInfo("pickaxe", 2).setHardness(3).setResistance(5);
		...
		subDesh = (SubBlockOre) new SubBlockOre("oreDesh", "amunra:ore-desh").setOredictNames("oreDesh").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subDiamond = (SubBlockOre) new SubBlockOre("oreDiamond", "amunra:ore-diamond").setOredictNames("oreDiamond").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subEmerald = (SubBlockOre) new SubBlockOre("oreEmerald", "amunra:ore-emerald").setOredictNames("oreEmerald").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subIron = (SubBlockOre) new SubBlockOre("oreIron", "amunra:ore-iron").setOredictNames("oreIron").setHarvestInfo("pickaxe", 2).setHardness(3).setResistance(5);

		subLapis = (SubBlockOre) new SubBlockOre("oreLapis", "amunra:ore-lapis").setOredictNames("oreLapis").setHarvestInfo("pickaxe", 1).setHardness(3).setResistance(5);

		subLithium = (SubBlockOre) new SubBlockOre("oreLithium", "amunra:ore-lithium").setOredictNames("oreLithium").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subRuby = (SubBlockOre) new SubBlockOre("oreRuby", "amunra:ore-ruby").setOredictNames("oreRuby").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subSilicon = (SubBlockOre) new SubBlockOre("oreSilicon", "amunra:ore-silicon").setOredictNames("oreSilicon").setHarvestInfo("pickaxe", 1).setHardness(3).setResistance(5);

		subTin = (SubBlockOre) new SubBlockOre("oreTin", "amunra:ore-tin").setOredictNames("oreTin").setHarvestInfo("pickaxe", 2).setHardness(3).setResistance(5);

		subTitanium = (SubBlockOreMultidrop) new SubBlockOreMultidrop("oreTitanium", "amunra:ore-titanium").setOredictNames("oreTitanium").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subCoal = (SubBlockOre) new SubBlockOre("oreCoal", "amunra:ore-coal").setOredictNames("oreCoal").setHarvestInfo("pickaxe", 1).setHardness(2).setResistance(5);

		subLead = (SubBlockOre) new SubBlockOre("oreLead", "amunra:ore-lead").setOredictNames("oreLead").setHarvestInfo("pickaxe", 2).setHardness(2).setResistance(5);

		subUranium = (SubBlockOre) new SubBlockOre("oreUranium", "amunra:ore-uranium").setOredictNames("oreUranium").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subSteel = (SubBlockOre) new SubBlockOre("oreSteel", "amunra:ore-steel").setOredictNames("oreSteel").setHarvestInfo("pickaxe", 3).setHardness(3).setResistance(5);

		subBone = (SubBlockOreMultidrop) new SubBlockOreMultidrop("oreBone", "amunra:ore-bone").setHarvestInfo("pickaxe", 1).setHardness(1).setResistance(5);
		...
		metaBlockAsteroidOre = new BlockOreMulti("asteroidMultiOre1", Constants.TEXTURE_PREFIX + "asteroid0", Material.ROCK);
		...
		/*
		 * // ICE ORE metaBlockIceOre = new BlockOreMulti("iceMultiOre", "ice_packed", Material.ice); metaBlockIceOre.setMultiblockHarvestLevel(1).setHardness(0.5F).setResistance(2.5F).setStepSound(Block.soundTypeGlass);
		 * 
		 * //blockRegistry.addObject(174, "packed_ice", (new BlockPackedIce()).setHardness(0.5F).setStepSound(soundTypeGlass).setBlockName("icePacked").setBlockTextureName("ice_packed")); //Blocks.packed_ice.slipperiness; metaBlockIceOre.register();
		 */

		metaBlockBossSpawner = new BlockMetaNonOpaqueInternal("bossSpawner", Material.air);
		osirisBossSpawner = metaBlockBossSpawner.addSubBlock(0, (SubBlock) new SubBlockBossSpawner("bossSpawner", Constants.TEXTURE_PREFIX + "blank").setBlockUnbreakable());
		...
		blockMsBase = metaBlockRock.addSubBlock(12, new SubBlockMassive("msBaseBlock", Constants.TEXTURE_PREFIX + "deco_aluminium_4", "", -1, -1.0F, 6000000.0F).setMass(0.1F));
		...
		blockMethaneTGrass = metaBlockPlant.addSubBlock(0, (SubBlock) new MethaneTallGrass("methaneTallGrass", "amunra:methanetallgrass").setHarvestInfo(null, 0).setHardness(0.0F));
		...
		blockIsotopeGeneratorBasic = metaBlockMachine.addSubBlock(0, new BlockIsotopeGenerator("isotopeGeneratorBasic", AmunRa.TEXTUREPREFIX + "machine_nuclear", // AmunRa.TEXTUREPREFIX + "machine_nuclear"
				Constants.TEXTURE_PREFIX + "machine_output", Constants.TEXTURE_PREFIX + "machine_blank", 0.5F));

		blockIsotopeGeneratorAdvanced = metaBlockMachine.addSubBlock(1, new BlockIsotopeGenerator("isotopeGeneratorAdvanced", AmunRa.TEXTUREPREFIX + "machine_nuclear_advanced", // AmunRa.TEXTUREPREFIX + "machine_nuclear"
				AsteroidsModule.TEXTURE_PREFIX + "machine_output", AsteroidsModule.TEXTURE_PREFIX + "machine", 5.0F));

		blockMothershipController = metaBlockMachine.addSubBlock(2, new BlockMothershipController("mothershipController", AmunRa.TEXTUREPREFIX + "controller", AsteroidsModule.TEXTURE_PREFIX + "machine"));

		blockMothershipSettings = metaBlockMachine.addSubBlock(3, new BlockMothershipSettings("mothershipSettings", AmunRa.TEXTUREPREFIX + "settings-terminal", AsteroidsModule.TEXTURE_PREFIX + "machine"));
		...
		// rocket engine
		blockMsEngineRocketJet = metaBlockMothershipEngineJet.addSubBlock(0, new MothershipEngineJetRocket("mothershipEngineRocketJet", AsteroidsModule.TEXTURE_PREFIX + "machine", AmunRa.TEXTUREPREFIX + "mothership-jet-rocket"// AsteroidsModule.TEXTURE_PREFIX + "machine"
		));

		blockMsEngineIonJet = metaBlockMothershipEngineJet.addSubBlock(1, new MothershipEngineJetIon("mothershipEngineRocketJetIon", AsteroidsModule.TEXTURE_PREFIX + "machine", AmunRa.TEXTUREPREFIX + "mothership-jet-ion"));

		metaBlockMothershipEngineJet.register();

		metaBlockMachine2 = new BlockMachineMeta("machines3", Material.iron);

		blockScale = metaBlockMachine2.addSubBlock(0, new BlockScale("blockScale", AmunRa.TEXTUREPREFIX + "scale_side", AmunRa.TEXTUREPREFIX + "scale_top", AmunRa.TEXTUREPREFIX + "scale", Constants.TEXTURE_PREFIX + "machine"));

		blockGravity = metaBlockMachine2.addSubBlock(1, new BlockGravitation("gravity", AmunRa.TEXTUREPREFIX + "gravity", AsteroidsModule.TEXTURE_PREFIX + "machine_input", AsteroidsModule.TEXTURE_PREFIX + "machine", AsteroidsModule.TEXTURE_PREFIX + "machine_input"));
		...
		blockHydro = metaBlockMachineSpecialRender1.addSubBlock(1, new BlockHydroponics("hydroponics", Constants.TEXTURE_PREFIX + "machine_input"));
		...
		blockMsEngineRocketBooster = metaBlockMothershipEngineBooster.addSubBlock(0, new MothershipEngineBoosterBase("mothershipEngineRocketBooster", AsteroidsModule.TEXTURE_PREFIX + "machine", AsteroidsModule.TEXTURE_PREFIX + "machine_side"));

		blockMsEngineIonBooster = metaBlockMothershipEngineBooster.addSubBlock(1, new MothershipEngineBoosterIon("mothershipEngineRocketBoosterIon", AsteroidsModule.TEXTURE_PREFIX + "machine", AsteroidsModule.TEXTURE_PREFIX + "machine_side_warning"));
	...
	private static void initChests() {
		...
		BlockARChest steelChest = new BlockARChestLarge(Material.ROCK, "steelChest", new ResourceLocation(AmunRa.ASSETPREFIX, "textures/model/chest-steel-single.png"), Constants.TEXTURE_PREFIX + "machine_blank");
