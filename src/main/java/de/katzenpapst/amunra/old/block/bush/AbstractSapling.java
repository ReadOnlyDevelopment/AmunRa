...
abstract public class AbstractSapling extends SubBlockBush {
	...
	/**
	 * func_149851_a is basically a stillGrowing() method. It returns (or should return) true if the growth stage is less than the max growth stage. info source: http://www.minecraftforge.net/forum/index.php?topic=22571.0
	 */
	@Override
	...
	protected boolean isBlockReplaceable(Block block) {
		return block instanceof BlockBushMulti || block.getMaterial() == Material.air || block.getMaterial() == Material.leaves || block == Blocks.grass || block == Blocks.dirt || block == Blocks.log || block == Blocks.log2 || block == Blocks.sapling || block == Blocks.vine;
	}
