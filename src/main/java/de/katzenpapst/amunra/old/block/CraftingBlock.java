...
public class CraftingBlock extends SubBlock {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		blockIconSide = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "machine_side");
		blockIconBottom = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "machine");
