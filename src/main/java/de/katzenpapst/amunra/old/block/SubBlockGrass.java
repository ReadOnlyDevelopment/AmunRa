...
public class SubBlockGrass extends SubBlock {
	...
	/**
	 * Return true if the current conditions are good for this grasses survival, usually light stuff The Multiblock will replace it with this.getDirtBlock() Will also be called for dirt neighbors of this in order to check if this *could* live there
	 *
	 * @param world
	 * @param x
	 * @param y
	...
	/**
	 * Return true if the conditions are right in order for this grass block to spread. This can be considered an extension of canLiveHere; if that returned true for a block, then canSpread is called for it, and only then the neighbors are compared to this.getDirtBlock() and this.canLiveHere() is called on them.
	 *
	 * @param world
	 * @param x
	 * @param y
	...
	/**
	 * Called when something could grow on top of this block The coordinates are of the block ABOVE this one, they can be used right away
	 *
	 * @param world
	 * @param rand
	 * @param x
