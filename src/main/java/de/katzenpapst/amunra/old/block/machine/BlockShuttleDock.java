...
public class BlockShuttleDock extends SubBlockMachine {
	...
	public BlockShuttleDock(String name, String texture, String tool, int harvestLevel, float hardness, float resistance) {
	...
	/*
	 * @Override public boolean canReplace(World world, int x, int y, int z, int probablySide, ItemStack stack) { return this.getSubBlock(stack.getItemDamage()).canReplace(world, x, y, z, probablySide, stack); }
	 */
	@Override
