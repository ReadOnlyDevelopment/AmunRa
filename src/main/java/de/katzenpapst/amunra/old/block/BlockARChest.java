...
public class BlockARChest extends BlockContainer implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc, IMassiveBlock {
	...
	/**
	 * Called upon block activation (right click on the block.) World world, int x, int y, int z, EntityPlayer player, int side, float xOffset, float yOffset, float zOffset
	 */
	@Override
