...
public class ARItems {
	...
	public static void initItems() {
		...
		/*
		 * jetItem = new ItemJet(ARBlocks.blockMsEngineRocketJet, "mothership-jet-rocket"); GameRegistry.registerItem(jetItem, jetItem.getUnlocalizedName(), AmunRa.MODID);
		 * 
		 * jetItemIon = new ItemJet(ARBlocks.blockMsEngineIonJet, "mothership-ion-rocket"); GameRegistry.registerItem(jetItemIon, jetItemIon.getUnlocalizedName(), AmunRa.MODID);
		 */
	...
	protected static void initOreDrops() {
		...
		ARBlocks.subSteel.setSmeltItem(steelIngot.getItemStack(1)).setDroppedItem(ARItems.ancientRebar).setXpDrop(3, 7).setBonusMultiplier(0.5F);
