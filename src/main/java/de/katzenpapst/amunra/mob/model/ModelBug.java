...
public class ModelBug extends ModelBase {
	...
	public void setRotationAngles(float time, float walkSpeed, float appendageRotation, float rotationYaw, float rotationPitch, float cale, Entity entity) {
		...
		/*
		 * this.spiderLeg1.rotateAngleY += leg1Y; this.spiderLeg2.rotateAngleY += -leg1Y; this.spiderLeg3.rotateAngleY += leg3Y; this.spiderLeg4.rotateAngleY += -leg3Y; this.spiderLeg5.rotateAngleY += leg6Y; this.spiderLeg6.rotateAngleY += -leg6Y; this.spiderLeg7.rotateAngleY += leg7Y; this.spiderLeg8.rotateAngleY += -leg7Y;
		 * 
		 * this.spiderLeg1.rotateAngleZ += leg1Z; this.spiderLeg2.rotateAngleZ += -leg1Z; this.spiderLeg3.rotateAngleZ += leg3Z; this.spiderLeg4.rotateAngleZ += -leg3Z; this.spiderLeg5.rotateAngleZ += leg5Z; this.spiderLeg6.rotateAngleZ += -leg5Z; this.spiderLeg7.rotateAngleZ += leg7Z; this.spiderLeg8.rotateAngleZ += -leg7Z;
		 */
