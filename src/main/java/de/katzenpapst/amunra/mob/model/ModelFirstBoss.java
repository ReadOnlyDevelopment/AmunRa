...
public class ModelFirstBoss extends ModelBiped {
	...
	/*
	 * public ModelFirstBoss(float scaleOrSo) { super(scaleOrSo); }
	 * 
	 * public ModelFirstBoss(float scaleOrSo, float someYoffset, int textureX, int textureY) { super(scaleOrSo, someYoffset, textureX, textureY); }
	 */
