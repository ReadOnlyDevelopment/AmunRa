...
public class EntityMummyBoss extends EntityMob implements IRangedAttackMob, IEntityBreathable, IAmunRaBoss {
	...
	public void despawnBoss() {
		...
		List<EntityPlayer> entitiesWithin2 = this.world.getEntitiesWithinAABB(EntityPlayer.class, aabb);
	...
	public ITileDungeonSpawner getSpawner() {
		if (spawner == null && spawnerPos != null) {
			TileEntity te = this.world.getTileEntity(spawnerPos.x, spawnerPos.y, spawnerPos.z);
	...
	protected void onDeathUpdate() {
		...
		if (this.deathTicks >= 180 && this.deathTicks <= 200) {
			...
			this.world.spawnParticle("hugeexplosion", this.posX + f, this.posY + 2.0D + f1, this.posZ + f2, 0.0D, 0.0D, 0.0D);
		}
		...
		if (!this.world.isRemote) {
			if (this.deathTicks >= 180 && this.deathTicks % 5 == 0) {
				GalacticraftCore.packetPipeline.sendToAllAround(new PacketSimple(EnumSimplePacket.C_PLAY_SOUND_EXPLODE, new Object[] {}), new TargetPoint(this.world.provider.dimensionId, this.posX, this.posY, this.posZ, 40.0D));
			}
			...
			if (this.deathTicks == 1) {
				GalacticraftCore.packetPipeline.sendToAllAround(new PacketSimple(EnumSimplePacket.C_PLAY_SOUND_BOSS_DEATH, new Object[] {}), new TargetPoint(this.world.provider.dimensionId, this.posX, this.posY, this.posZ, 40.0D));
			}
		}
	...
	protected void performAttack(Entity target) {
		...
		EntityOsirisBossFireball entitylargefireball = new EntityOsirisBossFireball(this.world, this, startX, startY, startZ);
