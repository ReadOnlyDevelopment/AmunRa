...
public class EntityPorcodon extends EntityAnimal implements IEntityBreathable, IEntityNonOxygenBreather {
	...
	public EntityAgeable createChild(EntityAgeable p_90011_1_) {
		return new EntityPorcodon(this.world);
	}
	...
	private void explode() {
		if (!this.world.isRemote) {
			boolean flag = this.world.getGameRules().getGameRuleBooleanValue("mobGriefing");
	...
	public boolean getCanSpawnHere() {
		return MobHelper.canAnimalSpawnHere(this.world, this, ARBlocks.blockMethaneGrass);
	}
