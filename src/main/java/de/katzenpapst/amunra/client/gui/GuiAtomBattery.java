...
public class GuiAtomBattery extends GuiContainerGC {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		displayString = GCCoreUtil.translate("gui.message.generating.name") + ": " + (this.generatorTile.generateWatts > 0 ? EnergyDisplayHelper.getEnergyDisplayS(this.generatorTile.generateWatts) + "/t" : GCCoreUtil.translate("gui.status.notGenerating.name"));
