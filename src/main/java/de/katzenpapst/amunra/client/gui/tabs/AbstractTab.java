...
abstract public class AbstractTab {
	...
	/**
	 * Handles keyboard input. / public void handleKeyboardInput() { if (Keyboard.getEventKeyState()) { this.keyTyped(Keyboard.getEventCharacter(), Keyboard.getEventKey()); } }
	 */
		...
		if (p_73864_3_ == 0) {
			for (int l = 0; l < this.buttonList.size(); ++l) {
				...
				if (guibutton.mousePressed(this.mc, p_73864_1_, p_73864_2_)) {
					ActionPerformedEvent.Pre event = new ActionPerformedEvent.Pre(this.parent, guibutton, this.buttonList);
