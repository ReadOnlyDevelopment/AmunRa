...
import de.katzenpapst.amunra.old.tile.TileEntityShuttleDock.DockOperation;
...
public class GuiShuttleDock extends GuiContainerGC {
	...
	protected List<String> getStatus() {
		/*
		 * gui.message.dock.status.obstructed=There are blocks in the way. Shuttles cannot dock here. gui.message.dock.status.occupied=A shuttle is docked here. gui.message.dock.status.free=This dock is vacant.
		 */
		if (tile.hasShuttle())
	...
	public void initGui() {
		...
		shuttleInfoRegion = new GuiElementInfoRegion((this.width - this.xSize) / 2 + 23, (this.height - this.ySize) / 2 + 57, 18, 27, new ArrayList<String>(), this.width, this.height, this);
		...
		buttonGetShuttle = new GuiButton(0, (this.width - this.xSize) / 2 + 52, (this.height - this.ySize) / 2 + 20, 72, 20, GCCoreUtil.translate("gui.message.dock.action.get"));

		buttonEnterShuttle = new GuiButton(1, (this.width - this.xSize) / 2 + 52, (this.height - this.ySize) / 2 + 56, 72, 20, GCCoreUtil.translate("gui.message.dock.action.enter"));

		buttonPutShuttle = new GuiButton(2, (this.width - this.xSize) / 2 + 52, (this.height - this.ySize) / 2 + 93, 72, 20, GCCoreUtil.translate("gui.message.dock.action.deploy"));
