...
public class GuiIonEngine extends GuiRocketEngine {
	...
	public void initGui() {
		super.initGui();
		electricInfoRegion = new GuiElementInfoRegion((this.width - this.xSize) / 2 + 113, (this.height - this.ySize) / 2 + 29, 56, 9, new ArrayList<String>(), this.width, this.height, this);
