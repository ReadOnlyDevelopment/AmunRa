...
public class RenderShuttleDock extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float partialTicks) {
		...
		/*
		 * Block block = dock.getWorldObj().getBlock(dock.xCoord, dock.yCoord, dock.zCoord); tessellator.setBrightness(block.getMixedBrightnessForBlock(dock.getWorldObj(), dock.xCoord, dock.yCoord, dock.zCoord));
		 * 
		 */
