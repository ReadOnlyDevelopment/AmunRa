...
public class RenderMothershipBooster extends TileEntitySpecialRenderer {
	...
	protected void renderMSBooster(TileEntityMothershipEngineBooster entity, double x, double y, double z, float partialTickTime) {
		GL11.glPushMatrix();
		...
		/*
		 * renderFaceYNeg = 0 renderFaceYPos = 1 renderFaceZNeg = 2 renderFaceZPos = 3 renderFaceXNeg = 4 renderFaceXPos = 5
		 */
